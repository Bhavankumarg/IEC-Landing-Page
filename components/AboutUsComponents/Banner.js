...
const Banner = () => {
  ...
  return (
    <div data-aos="zoom-in" className="lg:h-[70vh] h-[650px] lg:bg-[url('/about-us/banner.png')] bg-[url('/about-us/mobile-banner.png')] bg-cover m-0 p-0 relative flex flex-col items-center justify-center">
